...
@section('content')
                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a class="" href="{{ url('produk/edit/' . $produk->id) }}">Edit Produk</a>
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="card">
        <div class="card-header text-bg-primary">
            <h4 class="mb-0 text-white">Edit Produk</h4>
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_produk" class="form-control"
                                    placeholder="Contoh: Paket Internet 20 Mbps" value="{{ $produk->nama_produk }}"
                                    required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="bandwidth" class="form-control" placeholder="Contoh: 20 Mbps"
                                    value="{{ $produk->bandwidth }}" required />
                                <small class="form-control-feedback">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="harga" name="harga" class="form-control"
                                    placeholder="Contoh: 150000" value="{{ number_format($produk->harga, 0, ',', '.') }}"
                                    required />
                                <small class="form-control-feedback">
