                                                    ...
                                                    <div class="col-6">
                                                        <div class="position-relative">
                                                            ...
                                                            <a href="./main/app-invoice.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-invoice.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <a href="./main/app-contact2.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-mobile.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <a href="./main/app-email.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-message-box.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="position-relative">
                                                            <a href="./main/page-user-profile.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-cart.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <a href="./main/app-calendar.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-date.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <a href="./main/app-contact.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-lifebuoy.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                                            ...
                                                            <a href="./main/app-notes.html"
                                                                ...
                                                                <div
                                                                    class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                    <img src="{{ url('') }}/assets/images/svgs/icon-dd-application.svg"
                                                                        alt="modernize-img" class="img-fluid"
                                                                        width="24" height="24" />
                                                                </div>
                                                                <div>
                                ...
                                <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="profile-dropdown position-relative" data-simplebar>
                                        ...
                                        <div class="message-body">
                                            ...
                                            @if ($mitra)
                                            <a href="{{ route('view_profile', ['id' => $mitra->id]) }}"
                                            ...
                                            @else
                                                <a href="{{ route('add_profile') }}"
                                                    ...
                                                    <div class="w-100 ps-3">
                                                        <h6 class="mb-1 fs-3 fw-semibold lh-base">Lengkapi Profil</h6>
                                                        <span class="fs-2 d-block text-body-secondary">Isi data mitra
                                                            Anda</span>
                                                    </div>
                                                </a>
                                            @endif
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar"
                ...
                <nav class="sidebar-nav scroll-sidebar">
                    <div class="offcanvas-header justify-content-between">
                        <img src="{{ url('') }}/assets/images/logos/favicon.ico" alt="modernize-img"
                            class="img-fluid" />
