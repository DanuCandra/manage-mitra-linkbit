    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit Tagihan</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Tagihan</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-bg-primary">
                <h4 class="mb-0 text-white">Edit Tagihan - {{ $tagihan->no_tagihan }}</h4>
            </div>
            <form action="{{ url('/admin/tagihan/update/' . $tagihan->id) }}" method="POST">
                @csrf
                <div>
                    <div class="card-body">
                                    ...
                                    <select name="mitra_id" id="mitra_id"
                                        ...
                                        @foreach ($mitra as $m)
                                            <option value="{{ $m->id }}" data-bandwidth="{{ $m->bandwidth }}"
                                                {{ old('mitra_id', $tagihan->mitra_id) == $m->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="bandwidth_display" class="form-control"
                                        value="{{ $tagihan->bandwidth }}" readonly>
                                    <small class="text-muted">Bandwidth otomatis dari data mitra</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga_bandwidth"
                                        value="{{ old('harga_bandwidth', $tagihan->harga_bandwidth) }}"
                                        class="form-control @error('harga_bandwidth') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_tagihan"
                                        value="{{ old('tanggal_tagihan', $tagihan->tanggal_tagihan->format('Y-m-d')) }}"
