    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Add Account Bank</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Add Account Bank</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-bg-primary">
                <h4 class="mb-0 text-white">Add New Account Bank</h4>
            </div>
            <form action="{{ url('/admin/account-bank/store') }}" method="POST">
                @csrf
                <div>
                    <div class="card-body">
